...
const toLastNames = people => {
  let arr = people.reduce((newArr, person) => {
    console.log(newArr, person);
...
const addPurchases = (arr) => {
  return arr.reduce((newInt, i) => {
    return newInt += i.purchasePrice;
  }, 0);
};
...
const reversedString = (str) => {
  return str.split('').reduce((total, r)=>{
